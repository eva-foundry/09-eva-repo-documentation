# 09-eva-repo-documentation -- Acceptance Criteria
...
**Criteria**: `GET /model/projects/09-eva-repo-documentation` returns maturity, phase, pbi_total >= 1.
**Verification**:
```powershell
Invoke-RestMethod "http://localhost:8010/model/projects/09-eva-repo-documentation" |
...
**Verification**: Run MCP tool `audit_project` with target_path = C:\eva-foundry\09-eva-repo-documentation
**Status**: PENDING
...
**Verification**: Run MCP tool `get_trust_score` with repo_path = C:\eva-foundry\09-eva-repo-documentation
**Status**: PENDING
...
**Verification**: Run MCP tool `check_encoding` with target_path = C:\eva-foundry\09-eva-repo-documentation
**Status**: PENDING
