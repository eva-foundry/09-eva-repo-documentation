# 09-eva-repo-documentation -- Implementation Status
...
# Project facts
Invoke-RestMethod "$base/model/projects/09-eva-repo-documentation" | Select-Object id, maturity, phase, pbi_total, pbi_done
...
For veritas audit:
```
MCP tool: audit_repo  repo_path=C:\eva-foundry\09-eva-repo-documentation
MCP tool: get_trust_score  repo_path=C:\eva-foundry\09-eva-repo-documentation
```
...
**Data model record**: http://localhost:8010/model/projects/09-eva-repo-documentation
...
1. Run veritas audit: `audit_repo` MCP tool, repo_path = C:\eva-foundry\09-eva-repo-documentation
2. Check data model record: GET /model/projects/09-eva-repo-documentation
3. Update PLAN.md with actual sprint stories
4. Fill ACCEPTANCE.md gate table with project-specific criteria
5. Commit first evidence: PUT /model/projects/09-eva-repo-documentation with updated notes
