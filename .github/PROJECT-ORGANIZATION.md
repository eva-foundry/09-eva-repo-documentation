...
<!-- Placeholders: 09-eva-repo-documentation = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 09-eva-repo-documentation - Organization Standards
